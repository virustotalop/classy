...
\title{Classy Java \\ {\large A not so comprehensive guide to programming in Java}}
\author{Steven}
\begin{document}
...
\section{Loops}
Loops are there for when you want to get a job done and you don't want to write it multiple times. Loops are great to reduce code reuse which is something you should always strive to do. Writing code once and reusing it leads to less errors and a \emph{more happy programmer}.
